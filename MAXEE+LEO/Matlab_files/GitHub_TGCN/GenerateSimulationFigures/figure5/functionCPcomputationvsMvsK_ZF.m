function [P_ZF,cp] = functionCPcomputationvsMvsK_ZF(M,K,B,tau_c,tau_p,ULfraction,valueset,ThroughputPerCell)
...
%
%
%This function returns the total CP for ZF processing scheme only,
...
%
%OUTPUT:
%P_ZF   = Vector of same size as Mrange with total CP for ZF processing
%
...
P_CD_ZF = (P_COD + P_DEC)*ThroughputPerCell;
P_BH_ZF = P_BT*ThroughputPerCell;
...
P_ZF = P_SAME + P_CE + P_CD_ZF + P_BH_ZF + P_SP_UL_ZF;
