function [mu_kappa1, mu_kappa2] = functionComputeDistanceExpectation(pathLossExp_vec,distancesPathLossExp_vec,Gn_vec,lambdaRange)

%This Matlab function is called by the script plot_EEvsLP_multislope.m in the article:
%
...
mu_kappa1 = NaN*ones(1,length(lambdaRange));
mu_kappa2 = NaN*ones(1,length(lambdaRange));
...
for l = 1:length(lambdaRange)
    ...
    %save
    mu_kappa1(1,l) = mu_kappa1_sum;
    mu_kappa2(1,l) = mu_kappa2_sum;
end
